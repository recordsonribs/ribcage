...
// Defines
define('GETID3_VERSION', '1.7.1beta-2004.07.26_13:36');
...
class getID3
{
	...
	function getID3()
	{
		...
		if ($memory_limit <= 0) {
	    	...
	    	$this->startup_error .= 'PHP has less than 12MB available memory and might run out if all modules are loaded. Increase memory_limit in php.ini';
		}
