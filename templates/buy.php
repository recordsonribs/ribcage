		...
		<div id="post-17" class="hentry p1 page publish author-alex category-uncategorized tag- y2007 m07 d19 h23">
			<h2 class="entry-title"><a href="<?php get_option('siteurl') ?>/buy/<?php product_id(); ?>">Buying <?php product_name(); ?></a><h2>
				<div class="entry-content">
					...
					<h3>Pricing</h3>
					<p>CD Album & Postage (UK)£<?php product_cost_uk(); ?> <br /><a href="<?php get_option('siteurl') ?>/buy/<?php product_id(); ?>/go-uk">Buy Now</a></p>
						<p>CD Album & Postage (Worldwide) - £<?php product_cost_ww(); ?><br /><a href="<?php get_option('siteurl') ?>/buy/<?php product_id(); ?>/go-ww">Buy Now</a></p>
