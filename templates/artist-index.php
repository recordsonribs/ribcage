...
<?php while ( have_artists () ) : the_artist(); ?>
		...
		<a href="<?php echo get_option('siteurl'); ?>/artists/<?php artist_slug(); ?>" title="<?php artist_name(); ?>"><img src="<?php artist_thumb ();?>" align="right" style="margin-left: 20px; border: 1px solid #000;" /></a>
