...
<channel>
	...
	<item>
		...
		<link><a href="<?php echo home_url(); ?>/artists/<?php artist_slug(); ?>/<?php release_slug(); ?>/</link>
		...
		<content:encoded><![CDATA[<img src="<?php release_cover_tiny (); ?>" align="right" style="margin-left: 20px; border: 1px solid #000;" alt="<?php release_title(); ?>"/><?php release_blurb_long() ?><p><a href="<a href="<?php echo home_url(); ?>/artists/<?php artist_slug(); ?>/<?php release_slug(); ?>">More Information</a> - <a href="<?php release_player_link (); ?>">Listen Now</a> - <a href="<a href="<?php echo home_url(); ?>/download/<?php release_slug(); ?>/">Free Download</a><?php if (release_physical()) : ?> - <a href="<?php get_option('siteurl'); ?>/buy/<?php release_product_id(); ?>">Buy</a><?php endif; ?></p>	<p><em>This release is licensed under a 
