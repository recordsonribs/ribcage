				...
				<fieldset>
					...
					<table class="optiontable">                     
						...
						<tr valign="top">
							...
							<td>
								<input type="text" style="width:320px;" class="cleardefault" value="<?php echo $artist_license_val; ?>" name="artist_license" id="artist_license" value="by-nc-sa" maxlength="50" />
							</td> 
						</tr>
						<tr valign="top">
							<th scope="row"><strong>Arist Biography: </strong></th> 
							<td>
								<textarea rows="5" cols="50" name="artist_bio" id="artist_bio"><?php echo $artist_bio_val; ?></textarea>
							</td> 
						</tr>
						<tr valign="top">
							<th scope="row"><strong>Arist Picture 1: </strong></th> 
							<td>
						...
						<tr valign="top">
							<th scope="row"><strong>Arist Picture 2: </strong></th> 
							<td>
						...
						<tr valign="top">
							<th scope="row"><strong>Arist Picture 3: </strong></th> 
							<td>
						...
						<tr valign="top">
							<th scope="row"><strong>Arist Picture HQ Zipfile URL: </strong></th> 
							<td>
						...
						<tr valign="top">
							<th scope="row"><strong>Arist E-mail: </strong></th> 
							<td>
						...
						<tr valign="top">
							<th scope="row"><strong>Arist Phone: </strong></th> 
							<td>
